    ...
    return (
        <div className="flex bg-blue-50 min-h-screen">
            ...
            <main className="flex-1 px-8 pt-20 pb-12 md:px-12 h-screen overflow-y-auto">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            value={search} // HUBUNGKAN KE STATE
                ...
                {/* Grid List Ruangan */}
                {/* Grid List Ruangan - VERSI FILTER SEARCH */}
                {/* Grid List Ruangan - VERSI FIX FILTER SEARCH */}
                    ...
                    {rooms
                        ...
                        .map((room) => (
                            <div key={room.id} className="bg-white rounded-2xl overflow-hidden shadow-sm border border-blue-50 hover:shadow-md transition-all group">
                                ...
                                {/* 1. Bagian Image Ruangan (Pastikan ditutup </div> nya) */}
                                ...
                                </div> {/* <--- INI PENUTUP DIV GAMBAR YNG TADI HILANG */}
