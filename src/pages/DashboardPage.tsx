...
const DashboardPage = () => {
  ...
  const stats = [
    { label: "Booking", value: 12, icon: Clock, color: "bg-blue-500", light: "bg-blue-50" },
    { label: "Approved", value: 8, icon: CheckCircle2, color: "bg-green-500", light: "bg-green-50" },
    { label: "Rejected", value: 2, icon: XCircle, color: "bg-red-500", light: "bg-red-50" },
    { label: "Canceled", value: 2, icon: AlertCircle, color: "bg-amber-500", light: "bg-amber-50" },
  ];
